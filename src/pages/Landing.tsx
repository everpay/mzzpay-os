...
function PartnersSection() {
  ...
  const paymentMethods = [
    ...
    { name: "Square", image: "/logos/square.svg" },
    { name: "Alipay", image: "/logos/alipay.svg" },
    { name: "WeChat Pay", image: "/logos/wechat-pay.svg" },
    { name: "Mercado Pago", image: "/logos/mercado-pago.svg" },
    { name: "PayU", image: "/logos/payu.svg" },
    { name: "Paytm", image: "/logos/paytm.svg" },
    { name: "OXXO", image: "/logos/oxxo.png" },
    { name: "Klarna", image: "/logos/klarna.svg" },
    { name: "Affirm", image: "/logos/affirm.svg" },
    { name: "Venmo", image: "/logos/venmo.svg" },
    { name: "Cash App", image: "/logos/cashapp.svg" },
    { name: "Shopify", image: "/logos/shopify.svg" },
    { name: "WooCommerce", image: "/logos/woocommerce.svg" },
    { name: "JazzCash", image: "/logos/methods/jazzcash.svg" },
    { name: "EasyPaisa", image: "/logos/methods/easypaisa.svg" },
