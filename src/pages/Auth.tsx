    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <Link to="/" className="flex items-center justify-center mb-2">
          <BrandLogo iconOnly iconSizeClassName="h-64 md:h-80" textClassName="text-foreground" />
        </Link>

        {isLogin ? (
          /* ── LOGIN ── */
          <div className="rounded-3xl border border-border bg-card p-8 shadow-elevated">
            <h2 className="font-display text-3xl font-bold text-foreground mb-2 text-center tracking-tight">
              Welcome back
            </h2>
            ...
            {signupComplete ? (
              <div className="py-4">
                ...
                {signupAttempts > 1 && (
                  <Alert className="mb-4 bg-muted/40 border-border">
                    ...
                    <AlertDescription className="text-xs text-muted-foreground space-y-1">
                      <p>
                        You've requested {signupAttempts} confirmation emails to this address. Each new request makes
                        the previous link expire. Use the most recent email to confirm your account.
                      </p>
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <Alert className="mb-4 bg-muted/40 border-border">
                  ...
                  <AlertDescription className="text-xs text-muted-foreground space-y-1">
                    <p>
                      Confirmation emails usually arrive in <strong>under 60 seconds</strong>. If yours hasn't shown up:
                    </p>
                    <ul className="list-disc list-inside space-y-0.5 ml-1">
                      <li>Check your spam/junk folder</li>
                      <li>
                        Verify <span className="font-mono">{email}</span> is spelled correctly
                      </li>
                      <li>Wait the full 5 minutes — temporary network or DNS delays can extend delivery</li>
                      <li>
                        Whitelist <span className="font-mono">noreply@mzzpay.io</span> with your email provider
                      </li>
                    </ul>
                  </AlertDescription>
                </Alert>
