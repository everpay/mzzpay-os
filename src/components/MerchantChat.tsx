...
async function streamChat({
  ...
  if (!resp.ok) {
    ...
    onError(resp.status, body.error || "Request failed");
    return;
  }
  ...
  if (!open) {
    return (
      <Button
        ...
        aria-label="Open MzzPay Assistant"
      >
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col w-[380px] h-[520px] rounded-2xl border border-border bg-card shadow-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-primary/5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-heading text-sm font-semibold text-foreground">MzzPay Assistant</span>
        </div>
      ...
      <div className="border-t border-border px-3 py-3">
        ...
        >
          <Input
            ...
            placeholder="Ask about payments, invoices…"
