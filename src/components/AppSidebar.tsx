...
const navItems: NavItem[] = [
  ...
  { to: "/invoices", icon: FileText, label: "Invoices" },
  {
    ...
    children: [
      ...
      { to: "/treasury", icon: Building2, label: "Multi-currency" },
  ...
  },
  {
    ...
    hiddenFromRoles: ["agent", "employee"],
    children: [
      { to: "/risk", icon: Eye, label: "Risk Profile" },
  ...
  { to: "/products", icon: Package, label: "Products", hiddenFromRoles: ["agent", "employee"] },
  {
    to: "/chargebacks",
    icon: Shield,
    label: "Chargebacks",
